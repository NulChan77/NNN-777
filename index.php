...
.banner {
    width: 100%;
    height: 300px; /* ปรับความสูงของแบนเนอร์ตามต้องการ */
    background-image: url('your-banner-image.jpg'); /* แทนที่ด้วยรูปภาพแบนเนอร์ของคุณ */
...
<form action="upload_banner.php" method="post" enctype="multipart/form-data">
    ...
    <div class="search-box">
        <form action="re_search.php" method="GET">
